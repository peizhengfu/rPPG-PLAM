...
class DeepPhys(nn.Module):
    ...
    def __init__(self, in_channels=3, nb_filters1=32, nb_filters2=64, kernel_size=3, dropout_rate1=0.25,
                 dropout_rate2=0.5, pool_size=(2, 2), nb_dense=128, img_size=36, num_heads=4, n_win=5):
        ...
        # # 添加双路由注意力机制
        # self.bi_level_attention1 = BiLevelRoutingAttention_nchw(dim=self.nb_filters1, num_heads=num_heads, n_win=n_win)
        # self.bi_level_attention2 = BiLevelRoutingAttention_nchw(dim=self.nb_filters2, num_heads=num_heads, n_win=n_win)
    ...
    def forward(self, inputs, params=None):
        ...
        gated1 = d2 * g1
        # 使用双路由注意力机制
        # attn_output1 = self.bi_level_attention1(r2)
        # gated1 = d2 * attn_output1
        ...
        # 第二层双路由注意力机制
        # attn_output2 = self.bi_level_attention2(r6)
        # gated2 = d6 * attn_output2
