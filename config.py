...
_C.TRAIN.DATA.PREPROCESS.CROP_HAND = CN()
_C.TRAIN.DATA.PREPROCESS.CROP_HAND.DO_CROP_HAND = True
_C.TRAIN.DATA.PREPROCESS.CROP_HAND.USE_LARGE_HAND_BOX = True
_C.TRAIN.DATA.PREPROCESS.CROP_HAND.LARGE_BOX_COEF = 1.0
_C.TRAIN.DATA.PREPROCESS.CROP_HAND.DETECTION = CN()
_C.TRAIN.DATA.PREPROCESS.CROP_HAND.DETECTION.DO_DYNAMIC_DETECTION = False
_C.TRAIN.DATA.PREPROCESS.CROP_HAND.DETECTION.DYNAMIC_DETECTION_FREQUENCY = 30
_C.TRAIN.DATA.PREPROCESS.CROP_HAND.DETECTION.USE_MEDIAN_HAND_BOX = False
...
_C.VALID.DATA.PREPROCESS.CROP_HAND = CN()
_C.VALID.DATA.PREPROCESS.CROP_HAND.DO_CROP_HAND = True
_C.VALID.DATA.PREPROCESS.CROP_HAND.USE_LARGE_HAND_BOX = True
_C.VALID.DATA.PREPROCESS.CROP_HAND.LARGE_BOX_COEF = 1.0
_C.VALID.DATA.PREPROCESS.CROP_HAND.DETECTION = CN()
_C.VALID.DATA.PREPROCESS.CROP_HAND.DETECTION.DO_DYNAMIC_DETECTION = False
_C.VALID.DATA.PREPROCESS.CROP_HAND.DETECTION.DYNAMIC_DETECTION_FREQUENCY = 30
_C.VALID.DATA.PREPROCESS.CROP_HAND.DETECTION.USE_MEDIAN_HAND_BOX = False
...
_C.TEST.DATA.PREPROCESS.CROP_HAND = CN()
_C.TEST.DATA.PREPROCESS.CROP_HAND.DO_CROP_HAND = True
_C.TEST.DATA.PREPROCESS.CROP_HAND.USE_LARGE_HAND_BOX = True
_C.TEST.DATA.PREPROCESS.CROP_HAND.LARGE_BOX_COEF = 1.0
_C.TEST.DATA.PREPROCESS.CROP_HAND.DETECTION = CN()
_C.TEST.DATA.PREPROCESS.CROP_HAND.DETECTION.DO_DYNAMIC_DETECTION = False
_C.TEST.DATA.PREPROCESS.CROP_HAND.DETECTION.DYNAMIC_DETECTION_FREQUENCY = 30
_C.TEST.DATA.PREPROCESS.CROP_HAND.DETECTION.USE_MEDIAN_HAND_BOX = False
...
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND = CN()
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.DO_CROP_HAND = True
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.USE_LARGE_HAND_BOX = True
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.LARGE_BOX_COEF = 1.0
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.DETECTION = CN()
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.DETECTION.DO_DYNAMIC_DETECTION = False
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.DETECTION.DYNAMIC_DETECTION_FREQUENCY = 30
_C.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.DETECTION.USE_MEDIAN_HAND_BOX = False
    ...
    if config.TRAIN.DATA.EXP_DATA_NAME == '':
        config.TRAIN.DATA.EXP_DATA_NAME = "_".join([config.TRAIN.DATA.DATASET, "SizeW{0}".format(
            ...
            str(config.TRAIN.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.TRAIN.DATA.PREPROCESS.DATA_TYPE)),
                                      ...
                                      "Crop_hand{0}".format(config.TRAIN.DATA.PREPROCESS.CROP_HAND.DO_CROP_HAND),
                                      "Large_box{0}".format(config.TRAIN.DATA.PREPROCESS.CROP_HAND.USE_LARGE_HAND_BOX),
                                      "Large_size{0}".format(config.TRAIN.DATA.PREPROCESS.CROP_HAND.LARGE_BOX_COEF),
                                      "Dyamic_Det{0}".format(config.TRAIN.DATA.PREPROCESS.CROP_HAND.DETECTION.DO_DYNAMIC_DETECTION),
                                        "det_len{0}".format(config.TRAIN.DATA.PREPROCESS.CROP_HAND.DETECTION.DYNAMIC_DETECTION_FREQUENCY),
                                        "Median_hand_box{0}".format(config.TRAIN.DATA.PREPROCESS.CROP_HAND.DETECTION.USE_MEDIAN_HAND_BOX)
                                              ])
        ...
        if config.VALID.DATA.EXP_DATA_NAME == '':
            config.VALID.DATA.EXP_DATA_NAME = "_".join([config.VALID.DATA.DATASET, "SizeW{0}".format(
                ...
                str(config.VALID.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.VALID.DATA.PREPROCESS.DATA_TYPE)),
                                        ...
                                        "Crop_hand{0}".format(config.VALID.DATA.PREPROCESS.CROP_HAND.DO_CROP_HAND),
                                        "Large_box{0}".format(config.VALID.DATA.PREPROCESS.CROP_HAND.USE_LARGE_HAND_BOX),
                                        "Large_size{0}".format(config.VALID.DATA.PREPROCESS.CROP_HAND.LARGE_BOX_COEF),
                                        "Dyamic_Det{0}".format(config.VALID.DATA.PREPROCESS.CROP_HAND.DETECTION.DO_DYNAMIC_DETECTION),
                                          "det_len{0}".format(config.VALID.DATA.PREPROCESS.CROP_HAND.DETECTION.DYNAMIC_DETECTION_FREQUENCY),
                                          "Median_hand_box{0}".format(config.VALID.DATA.PREPROCESS.CROP_HAND.DETECTION.USE_MEDIAN_HAND_BOX)
                                                ])
    ...
    if config.TEST.DATA.EXP_DATA_NAME == '':
        config.TEST.DATA.EXP_DATA_NAME = "_".join([config.TEST.DATA.DATASET, "SizeW{0}".format(
            ...
            str(config.TEST.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.TEST.DATA.PREPROCESS.DATA_TYPE)),
                                      ...
                                      "Crop_hand{0}".format(config.TEST.DATA.PREPROCESS.CROP_HAND.DO_CROP_HAND),
                                      "Large_box{0}".format(config.TEST.DATA.PREPROCESS.CROP_HAND.USE_LARGE_HAND_BOX),
                                      "Large_size{0}".format(config.TEST.DATA.PREPROCESS.CROP_HAND.LARGE_BOX_COEF),
                                      "Dyamic_Det{0}".format(config.TEST.DATA.PREPROCESS.CROP_HAND.DETECTION.DO_DYNAMIC_DETECTION),
                                        "det_len{0}".format(config.TEST.DATA.PREPROCESS.CROP_HAND.DETECTION.DYNAMIC_DETECTION_FREQUENCY),
                                        "Median_hand_box{0}".format(config.TEST.DATA.PREPROCESS.CROP_HAND.DETECTION.USE_MEDIAN_HAND_BOX)
                                              ])
    ...
    if config.UNSUPERVISED.DATA.EXP_DATA_NAME == '':
        config.UNSUPERVISED.DATA.EXP_DATA_NAME = "_".join([config.UNSUPERVISED.DATA.DATASET, "SizeW{0}".format(
            ...
            str(config.UNSUPERVISED.DATA.PREPROCESS.CHUNK_LENGTH)), "DataType{0}".format("_".join(config.UNSUPERVISED.DATA.PREPROCESS.DATA_TYPE)),
                                      ...
                                      "Crop_hand{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.DO_CROP_HAND),
                                      "Large_box{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.USE_LARGE_HAND_BOX),
                                      "Large_size{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.LARGE_BOX_COEF),
                                      "Dyamic_Det{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.DETECTION.DO_DYNAMIC_DETECTION),
                                        "det_len{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.DETECTION.DYNAMIC_DETECTION_FREQUENCY),
                                        "Median_hand_box{0}".format(config.UNSUPERVISED.DATA.PREPROCESS.CROP_HAND.DETECTION.USE_MEDIAN_HAND_BOX),
                                        "unsupervised"
                                              ])
