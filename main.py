...
def add_args(parser):
    ...
    '''Neural Method Sample YAML LIST:
      PURE_PALMVEIN_DEEPPHYS_BASIC.yaml
      PURE_PALMVEIN_EFFICIENTPHYS.yaml
      PURE_PALMVEIN_iBVPNet_BASIC.yaml
      PURE_PALMVEIN_PHYSFORMER_BASIC.yaml
      PURE_PALMVEIN_PHYSNET_BASIC.yaml
      PURE_PALMVEIN_TSCAN_BASIC.yaml
      UBFC-rPPG_PALMVEIN_DEEPPHYS_BASIC.yaml
      UBFC-rPPG_PALMVEIN_EFFICIENTPHYS.yaml
      UBFC-rPPG_PALMVEIN_iBVPNet_BASIC.yaml
      UBFC-rPPG_PALMVEIN_PHYSFORMER_BASIC.yaml
      UBFC-rPPG_PALMVEIN_PHYSNET_BASIC.yaml
      UBFC-rPPG_PALMVEIN_TSCAN_BASIC.yaml
    Unsupervised Method Sample YAML LIST:
      PURE_UNSUPERVISED.yaml
      UBFC-rPPG_UNSUPERVISED.yaml
      PALMVEIN_UNSUPERVISED.yaml
    '''
    return parser
...
if __name__ == "__main__":
    ...
    parser = data_loader.BaseLoad.BaseLoad.add_data_loader_args(parser)
    ...
    if config.TOOLBOX_MODE == "train_and_test":
        ...
        elif config.TRAIN.DATA.DATASET == "PALMVEIN":
            train_loader = data_loader.PalmVeinLoader.PalmVeinLoader
        else:
        ...
        if config.VALID.DATA.DATASET == "UBFC-rPPG":
            ...
            valid_loader = data_loader.PalmVeinLoader.PalmVeinLoader
        elif config.TRAIN.DATA.DATASET is None and not config.TEST.USE_LAST_EPOCH:
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.TEST.DATA.DATASET == "PALMVEIN":
            test_loader = data_loader.PalmVeinLoader.PalmVeinLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+ (Normal and BigSmall preprocessing), UBFC-PHYS and iBVP.")
        ...
        elif config.UNSUPERVISED.DATA.DATASET == "PALMVEIN":
            unsupervised_loader = data_loader.PalmVeinLoader.PalmVeinLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
